...
func main() {
	...
	err := deidentifyTableFPE(&buf, "ibcwe-event-layer-f3ccf6d9", 
		"projects/ibcwe-event-layer-f3ccf6d9/locations/global/keyRings/fpe-poc-keyring/cryptoKeys/fpe-poc-key",
		"CiQA+yi9TI2anWIJ9WGrZe4zeee9FQgFunT1YXafzLcWGgWQZj8SSQCfIIegX+iV9gc7NArQqZAM7GJ5CQMJjTv3r7PyvbgRfORvw2vNOi2pdcWg6BlOih7u8qfleQQR+3ulFad1+fpz99sS/vXIcgc=")
	if err != nil {
		fmt.Println(err)
	}
...
func deidentifyTableFPE(w io.Writer, projectID string, kmsKeyName, wrappedAESKey string) error {
        // projectId := "ibcwe-event-layer-f3ccf6d9"
        /* keyFileName :=  "projects/ibcwe-event-layer-f3ccf6d9/"
           + "locations/us-central1/"
           + "keyRings/dlp-fpe-keyring/"
           + "cryptoKeys/aes-encrypt-key"
        */
